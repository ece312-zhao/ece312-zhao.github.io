---
title: Course Schedule and Materials
layout: minimal
---
...
.exam {
  background-color:rgba(14, 158, 190, 0.15);
  text-align: center;
}
...
<table><thead>
  <tr>
    ...
    <th>Topic</th>
    <th>Materials</th>
    <th>Due (<strong><u>Before the Class</u></strong>)</th>
  </tr></thead>
<tbody>
<tr class="week-start">
...
<tr class="week-start">
    <td rowspan="3" class="week" id="week-2">Week 2</td>
    <td class="date">Jan 19</td>
    <td colspan="3" class="break">Martin Luther King Jr. Day (No Class)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>(L) Recursion</td>
    <td>
        <a href="files/Recursion.pdf" target="_blank">Slides</a>
        <a href="code/L12/recursion.c" target="_blank">Code</a>
    </td>
    <td><!-- Dues --></td>
</tr>
<tr class="recitation">
...
<tr>
    ...
    <td>
        ...
        <a href="code/L14/Calculator-Expr-Tree.zip" target="_blank">Code for Calculator Using an Expression Tree (changes are made in calculator.c)</a>
    </td>
    <td></td>
</tr>
<tr class="week-start">
...
<tr class="recitation">
    <td class="date">Mar 25</td>
    <td>(R) PA #5 Hints</td>
     <td><a href="files/8_PA5.pptx" target="_blank">Slides</a></td>
    <td><!-- Dues --></td>
</tr>
<tr class="week-start">
